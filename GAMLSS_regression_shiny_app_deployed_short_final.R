...
server <- function(input, output, session) {
  ...
  observe({
    ...
    output$familyInput <- renderUI({
      selectInput("family", "Family of Distribution", choices = c("BE","BB","BNB","BEOI",	"BEZI",	"BEINF","BI","BCCG","BCPE","BCT","DEL","DBURR12","DPO","DBI","EXP","exGAUS",	
                                                                  "EGB2",	"GA","GB1","GB2","GG","GIG","GT","GEOM","GEOMo","GU","IGAMMA","IG","JSU","LG","LO","LOGITNO",	
                                                                  "LOGNO","LNO","NBI","NBII","NBF","NET","NO","NOF","LQNO","PARETO2","PARETO2o","PE","PE2","PO","PIG","RGE","RG",	
